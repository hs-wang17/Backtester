...
scores_path = r"/home/user0/results/predictions/StockPredictor_20251117_123441_combined_predictions.csv"

data_path = r"/home/user0/project/backtester/data"
test_result_path = r"/home/user0/project/backtester/results"
path_dailyData = r"/home/user0/data/data_frames"
...
def preload_all_data():
    ...
    for date in date_list:
        data_cache["daily_price"][date] = get_daily_price(date)
    # 预加载daily_support数据
    for date in date_list:
        data_cache["daily_support"][date] = get_daily_support(date)
    print("数据预加载完成")
