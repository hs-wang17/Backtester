...
SUPPORT5_PATH = r"/home/haris/data/trade_support_data/trade_support5"
SUPPORT7_PATH = r"/home/haris/data/trade_support_data/trade_support7"

SCORES_PATH = r"/home/haris/results/predictions/StockPredictor_20251119_043804_combined_predictions.csv"  # 因子预测文件
...
STRATEGY = "solve"  # 策略
TOT_HOLD_NUM = 200  # 持仓个数
DAILY_SELL_NUM = 20  # 每日卖出个数
HOLD_INIT = "solve"  # 持仓初始化
...
def update_from_args(args):
    ...
    if args.start_date_shift:
        START_DATE_SHIFT = args.start_date_shift
    if args.lambda_sparse:
