...
VWAP_TWAP_PATH = r"/home/haris/raid0/shared/haris/vwap_twap"  # VWAP/TWAP数据
...
CITIC_LIMIT_SECOND = 0.06  # 行业(早盘第二阶段)
CMVG_LIMIT = 0.2  # 市值
...
TURN_MAX_SECOND = 0.09  # 换手率(早盘第二阶段)
MEM_HOLD = 0.2  # 成分股持仓
...
def update_from_args(args):
    ...
    if TRADE_SUPPORT == 5:
        ...
        CITIC_LIMIT_SECOND = 0.09522923178628084  # 行业(早盘第二阶段) (范围0-2)
        ...
        TURN_MAX_SECOND = 0.09379183056054619  # 换手率(早盘第二阶段) (范围0.03-0.2)
        ...
        if len(SCORES_PATH) > 1:
            ...
            CITIC_LIMIT_SECOND = 0.0  # 行业(早盘第二阶段) (范围0-0.5)
            ...
            TURN_MAX_SECOND = 0.06371569969647878  # 换手率(早盘第二阶段) (范围0.03-0.2)
        ...
        TURN_MAX_SECOND = 0.04  # 换手率(早盘第二阶段) (范围0.03-0.2)
    ...
    if hasattr(args, "citic_limit_second") and args.citic_limit_second is not None:
        CITIC_LIMIT_SECOND = args.citic_limit_second
    ...
    if hasattr(args, "turn_max_second") and args.turn_max_second is not None:
        TURN_MAX_SECOND = args.turn_max_second
