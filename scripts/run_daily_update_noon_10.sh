...
/home/haris/miniconda3/envs/myenv/bin/python /home/haris/project/backtester/run.py --scores_path "$LATEST_FILE" --trade_support 8 --afternoon_start True --results_path "/home/haris/mymodel_noon_10/backtests"
