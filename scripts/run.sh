...
/home/haris/miniconda3/envs/myenv/bin/python /home/haris/project/backtester/run.py --scores_path /home/haris/mymodel_noon_10/predictions/StockPredictor_20260308_merged_all_stocks.csv --trade_support 7 --afternoon_start True
...
/home/haris/miniconda3/envs/myenv/bin/python /home/haris/project/backtester/run.py --scores_path /home/haris/mymodel_10/predictions/StockPredictor_20260306_merged_all_stocks.csv --trade_support 7 --continuous_mode True  --turn_max 0.031857849848239 --turn_max_second 0.031857849848239
/home/haris/miniconda3/envs/myenv/bin/python /home/haris/project/backtester/run.py --scores_path /home/haris/mymodel_noon_10/predictions/StockPredictor_20260308_merged_all_stocks.csv --trade_support 7 --afternoon_start True --continuous_mode True  --turn_max 0.031857849848239 --turn_max_second 0.031857849848239
...
# 4-1) solve trade support 5 (APM mode)
...
# 4-2) solve trade support 7 (APM mode)
...
# 4-3) solve trade support barra (APM mode)
...
# 5-1) solve trade support 5 (call)
...
# 5-2) solve trade support 7 (call)
...
# 5-3) solve trade support barra (call)
